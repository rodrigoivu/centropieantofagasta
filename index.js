...
var credentials = {
	...
	key: fs.readFileSync("/etc/letsencrypt/live/centropiecmds.cl/privkey.pem"), //la clave SSL, que es el primer archivo que generamos ;)
	cert: fs.readFileSync("/etc/letsencrypt/live/centropiecmds.cl/fullchain.pem") //el certificado
